...
public class CollectibleMatchController : MonoBehaviour
{
    ...
    private int _serialMatchCount = 0;

    public int SerialMatchCount
    {
        get => _serialMatchCount;
        set => _serialMatchCount = value;
    }
        ...
        for (int i = 0; i < collectiblesCount - 1; i++)
        {
            ...
            if (matchingCollectiblesCount == _matchCubeCount)
            {
                ...
                _characterVisual.localPosition = new Vector3(_characterVisual.localPosition.x,
                    _characterVisual.localPosition.y - _collectibleHandler.AmountOfRise * _matchCubeCount,
                    _characterVisual.localPosition.z);
                ...
                OnCollectiblesMatched?.Invoke(_serialMatchCount);
