...
public class UserSaveManager : MonoBehaviour
{
	...
	{
		int totalPlayableLevelCount = UnityEngine.SceneManagement.SceneManager.sceneCountInBuildSettings - 1;
	...
	public int GetVirtualLevelID()
	{
		...
		int curSceneID = GetLastCompletedCount() % (UnityEngine.SceneManagement.SceneManager.sceneCountInBuildSettings - 1) + 1;
